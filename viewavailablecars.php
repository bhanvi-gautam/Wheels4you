...
<div id="sec2" >
        <h3 style="text-align:center; color:white;">All Cars</h3>
        <br>
        <section class="menu-content">
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
                    ...
                    $availability=$row1["car_availability"]
            ...
            <div class="sub-menu">
                ...
                <h6> Availability: <?php echo $availability;?></h6>
                <a href="update-car.php?id=<?php echo $car_id;?>" class="btn-success">Update Admin</a>
                <a href="delete-car.php?id=<?php echo $car_id;?>" class="btn-danger">Delete Admin</a>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> Wheels4you</h5>
                </div>
